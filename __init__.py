...
class ImageRecognitionSkill(MycroftSkill):
    ...
    def handle_img_recog_intent(self, message):
        ...
        results = classifier.local_image_classification(dirname(__file__)+"/test.jpg", message.data.get("target"))
        i = 0
    ...
    def handle_deep_draw(self, message):
        ...
        try:
            ...
            self.log.error("Could not upload to imgur")
            link = None# send result
